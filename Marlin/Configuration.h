...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
#define DEFAULT_Kp 25.00 //AndyC was 17.46
#define DEFAULT_Ki 4.00 //AndyC was 1.35
#define DEFAULT_Kd 240.00 //AndyC was 56.50
  #endif
...
#define DEFAULT_bedKp 61.79 //AndyC was 85.15 (before fitting insulation)
#define DEFAULT_bedKi 12.05 //AndyC was 14.85 (before fitting insulation)
#define DEFAULT_bedKd 211.33 //AndyC was 325.63 (before fitting insulation)
  #endif
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 500, 413 }  // Bontech recommends 413 for BMG extruder @ 1.8 degree stepper, 16 microsteps
  ...
  // Bondtech recommends 413 for BMG extruder @ 1.8 degree stepper, 16 microsteps
  // 413 / 2 * 0.95 = 196.2  (2 is for 8 microsteps, 0.9 to reduce extrusion)

  #if (SK_USTEPS == 8)
    #define STEPS_E 196.2
  #elif (SK_USTEPS == 16)
    #define STEPS_E 417.0 // AndyC was 413 then 408.8
  #endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 30, 100 } //AndyC was { 500, 500, 30, 100 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1200, 1200, 100, 2000 } //AndyC was { 2000, 2000, 100, 2000 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.05 // (mm) Distance from real junction edge //AndyC was 0.02
#endif
 ...
 */
 #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //AndyC
 ...
 */
#define BLTOUCH //AndyC was disabled
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -17.5, 10, -1.80 } //AndyC was 22,8,-2.66

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define MIN_PROBE_EDGE 20 //AndyC was 35
...
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 4) //AndyC was /2
...
// Travel limits (mm) after homing, corresponding to endstop positions.
  ...
  //         (X_MIN_POS, Y_MIN_POS), for example (-5, -20), is the homing position
  //         and will be shown in the display after homing.
  //         This can be changed according to your assembly.
  #define X_MIN_POS -7 //AndC was -4
  #define Y_MIN_POS -16 //AndyC was -26
#endif
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM   30 //AndyC was 5
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE         60    // (mm/s) Feedrate for XY Moves for the G26 Mesh Validation Tool. //AndyC Was 60
  #endif
...
#else
  #define MESH_INSET 30              // Set Mesh bounds as an inset region of the bed //AndyC was 30
#endif
  #define GRID_MAX_POINTS_X 10      // Don't use more than 15 points per axis, implementation limited. //AndyC was 10
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X

  #define UBL_MESH_EDIT_MOVES_Z     // Sophisticated users prefer no movement of nozzle //AndyC was enabled
  #define UBL_SAVE_ACTIVE_ON_M500   // Save the currently active mesh in the current slot on M500

  //#define UBL_Z_RAISE_WHEN_OFF_MESH 2.5 // When the nozzle is off the mesh, this value is used //AndyC Was disabled
...
#define PREHEAT_1_TEMP_HOTEND 180 //AndyC was 200
#define PREHEAT_1_TEMP_BED     60 //AndyC was 50
